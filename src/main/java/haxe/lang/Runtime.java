...
public class Runtime
{
	...
	public static boolean slowHasField(java.lang.Object o, java.lang.String field)
	{
		...
		try
		{
			Field f = ClassReflection.getField(cl, field);
			return true;
		}
		catch(Throwable t)
		{
			Method[] ms = ClassReflection.getMethods(cl);
	...
	public static java.lang.Object slowSetField(java.lang.Object obj, java.lang.String field, java.lang.Object value)
	{
		...
		try {
			...
			if (isInt(value))
			{
				f.set(obj, toInt(value));
			} else if (isDouble(value)) {
				f.set(obj, toDouble(value));
			} else {
				f.set(obj, value);
			}
			return value;
	...
	public static java.lang.Object slowCallField(java.lang.Object obj, java.lang.String field, haxe.root.Array args)
	{
		...
		for (int i = 0; i < len; i++)
		{
			...
			for (int j = 0; j < msl; j++)
			{
				...
				if (i < allcls.length)
				{
					if (!  ((isNum && ClassReflection.isPrimitive(allcls[i])) || ClassReflection.isAssignableFrom(allcls[i], cls[i])) )
					{
						ms[j] = null;
					} else {
						ms[realMsl] = ms[j];
		...
		if (hasNumber)
		{
			...
			for (int i = 0; i < len; i++)
			{
				...
				if (o instanceof java.lang.Number)
				{
					...
					{
						curCls = allcls[i];
						if (!ClassReflection.isAssignableFrom(curCls, o.getClass()))
						{
