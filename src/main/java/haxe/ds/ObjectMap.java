...
public class ObjectMap<K, V> extends haxe.lang.HxObject implements haxe.IMap<K, V>
{
	...
	public void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				{
					K[] k2 = ((K[]) new Object[newNBuckets]);
					java.lang.System.arraycopy(_keys, 0, k2, 0, newNBuckets);
					this._keys = k2;
				}
				
				{
					V[] v1 = ((V[]) new Object[newNBuckets]);
	...
	{
		{
			...
			switch (field.hashCode())
			{
				...
				case -553141795:
				{
					if (field.equals("cachedKey")) 
					{
						return haxe.lang.Runtime.toDouble(this.cachedKey);
					}
